"""
Archived Server Script: Raven Channel Permission Patch - Startup

V13.6.0 P3 Server Script Migration
Decision: DEL / archive_enabled_one_shot
Script Type: DocType Event
Reference DocType: System Settings
Disabled: 0
...
frappe.logger().info("✅ Parche de permisos de Raven aplicado al iniciar")
